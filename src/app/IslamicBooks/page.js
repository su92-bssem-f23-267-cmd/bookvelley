...
import Islamicsection from '../componenets/Islamicsection'
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex flex-col'>
      ...
      <div className='bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 h-auto md:h-96 w-full flex flex-col md:flex-row justify-center items-center rounded-b-[40px] text-white shadow-2xl px-4 py-8 md:py-0 mt-20 relative overflow-hidden'>
        ...
        <img src='/Quran_E_Pak-removebg-preview.png' className='h-40 md:h-72 mb-4 md:mb-0 rounded-4xl relative z-10 transform hover:scale-110 transition-transform duration-300' alt='Books' />
        ...
        <img src='/man_Reading_Quran-removebg-preview.png' className='h-48 md:h-80 mt-9 md:mt-0 relative z-10 transform hover:scale-110 transition-transform duration-300' alt='Girl reading' />
      </div>
